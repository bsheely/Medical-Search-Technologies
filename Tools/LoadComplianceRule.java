...
public class LoadComplianceRule {
    private final String ORG_ID = "58c6f3ceaf3c420b90160803";
    private BusinessRuleDao dao;

    public LoadComplianceRule() {
        String devServer = "10.0.129.218";
        String database = "test";
        init(devServer, database);
    }

    LoadComplianceRule(String server, String database) {
    ...
    public void saveRule() {
        ...
        // rule 1 Aortic Aneurysm
        rule = new Compliance();
        rule.setRuleName("Aortic Aneurysm");
        ...
        edgesToMatch.put(diseaseLocation, new ArrayList<>(Arrays.asList("abdominal","infrarenal","diaphragm","celiac","axis","sma","ima","suprarenal","aorta")));
        ...
        // rule 2 Abdominal Aortic Aneurysm
        rule = new Compliance();
        rule.setRuleName("Abdominal Aortic Aneurysm");
        edgesToMatch = new HashMap<>();
        edgesToMatch.put(existence, new ArrayList<>(Collections.singletonList("aaa")));
        rule.setEdgesToMatch(edgesToMatch);
        buckets = new ArrayList<>();
        bucket = new Compliance.Bucket();
        bucket.setBucketType(COMPLIANCE);
        ...
        // rule 3 Incidental Thyroid Nodule
        rule = new Compliance();
        rule.setRuleName("Incidental Thyroid Nodule");
        edgesToMatch  = new HashMap<>();
        edgesToMatch.put(existence, new ArrayList<>(Arrays.asList("nodule","nodules","mass","masses","lesion","lesions","cyst","cysts","hypodensity","hypodensities","attenuation","attenuations")));
        ...
        // rule 5 Ovarian Simple Cyst
        rule = new Compliance();
        rule.setRuleName("Ovarian Simple Cyst");
        edgesToMatch  = new HashMap<>();
        edgesToMatch.put(existence, new ArrayList<>(Arrays.asList("cyst","cysts","follicle","follicles","lesion","lesions","transmission","transmissions","attenuation","attenuations")));
    ...
    private void init(String server, String database) {
